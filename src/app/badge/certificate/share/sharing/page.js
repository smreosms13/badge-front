        ...
        <>
            <div className="flex items-center justify-center flex-1 bg-blue-900 rounded-3xl text-white h-12 mb-4">
                <input
                    ...
                    className="px-2 py-1 text-black bg-white rounded-md focus:outline-none mr-3"
                />
                <button type="submit" className="flex items-center justify-center bg-blue-600 rounded-xl p-1" onClick={handleButtonClick}>
